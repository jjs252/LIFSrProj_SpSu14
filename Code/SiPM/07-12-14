...
#define SiPMpin 4 // SiPM power reading pin
#define VMAX12 4095
#define VMAX16 65536
#define VRF 3.3
#define T0 298.15
...
volatile int PIDtimerInterruptInMilliSeconds = 10000;
...
void calculatePID(){
 // if(runPIDtimerInterrupt){  // I am unsure if I should simply comment out this if statement. Boolean is never set true
...
void PIDtimer_setup(){
  PIDtimer.begin(calculatePID, PIDtimerInterruptInMilliSeconds);
}
